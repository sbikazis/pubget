...
class UploadEditScreen extends StatefulWidget {
  ...
  @override
  State<UploadEditScreen> createState() =>
      _UploadEditScreenState();
}

class _UploadEditScreenState
    extends State<UploadEditScreen> {
