    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: Row(children: [
          ...
          Expanded(
              child: Text('تمت العملية بنجاح! مبروك حصلت على +$amount عملة مشعة.',
                  style: TextStyle(
          ...
          Expanded(
            ...
            _buildTaskCard(context,
                ...
                onTap: () async {
                  ...
                  bool adShown = await adService.showSingleRewardedAd(onReward: () {});

                  if (adShown) {
                    bool success = await context.read<StoreProvider>().rewardForWatchingAd();
                    if (success) {
                  ...
                  return _buildTaskCard(context,
                      ...
                      onTap: canPlay
                         ? () async {
                              ...
                              if (groups.isEmpty) {
                                _showErrorSnackBar(context, 'انضم لمجموعة أولاً');
                                return;
                              }
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (_) => ChatScreen(
                                          groupId: randomGroup.id, openEventsOnStart: true)));
                            }
                          : null);
                }),
            // 4- إديت
            FutureBuilder<bool>(
                ...
                builder: (ctx, snap) {
                  ...
                  return _buildTaskCard(context,
                      title: 'نشر مقطع إديت',
                      subtitle: canEarn? 'انشر واربح +10' : 'تم أخذ مكافأة اليوم',
                      reward: '+10',
                      icon: Icons.video_collection_rounded,
                      actionText: canEarn? 'نشر مقطع' : 'مكتمل',
                      enabled: canEarn, // ✅ تم التصحيح
                      onTap: canEarn
                         ? () => Navigator.push(
                              ctx, MaterialPageRoute(builder: (_) => const UploadEditScreen()))
                          : null);
                }),
            // 5- سوشيال
            _buildTaskCard(context,
  ...
  Widget _buildTaskCard(BuildContext context,
    ...
    return Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
                color: isAd? const Color(0xFF00FF87).withOpacity(0.4) : theme.dividerColor.withOpacity(0.15))),
        child: Row(children: [
          Container(
              padding: const EdgeInsets.all(10),
              decoration: BoxDecoration(
                  color: isAd? const Color(0xFF00FF87).withOpacity(0.15) : const Color(0xFF7C4DFF).withOpacity(0.12),
                  shape: BoxShape.circle),
              child: Icon(icon, color: isAd? const Color(0xFF00FF87) : const Color(0xFF7C4DFF), size: 24)),
          ...
          Expanded(
            ...
            Text(subtitle, style: TextStyle(color: theme.textTheme.bodyMedium?.color?.withOpacity(0.7)?? Colors.grey, fontSize: 12)),
          ...
          ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                  backgroundColor: enabled? (isAd? const Color(0xFF00FF87) : const Color(0xFF7C4DFF)) : Colors.grey.shade700,
