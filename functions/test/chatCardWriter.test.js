...
test("registries agree: mafia is excluded from the generic game registry", () => {
  ...
  assert.equal(GAME_TYPE_REGISTRY.animeChain.genericCreate, true);
  assert.equal(GAME_TYPE_REGISTRY.emojiAnimeGuess.genericCreate, true);
});
